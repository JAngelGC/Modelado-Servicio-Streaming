...
int main()
{
    ...
    while (ciclarMenu)
    {
        ...
        cout << "\n*********** M O D E L A D O   D E   S E R V I C I O   D E   S T R E A M I N G ***********" << endl
             << endl;
        cout << "Bienvenid@ a la aplicacion en donde podras buscar tus titulos favoritos" << endl
             << endl;
        ...
        cout << "Ingresa la opcion del menu que te interese (El programa solo tomara el entero del numero que ingreses): ";
        int opcion;
        ...
        else if (opcion == 2) // Mostrar los videos en general con una cierta calificación o de un cierto género
        {
            ...
            if (hayArchivos == 1)
            {
                ...
                cout << "\nIngresa el numero de la opcion que desees (El programa solo tomara el entero del numero que ingreses): ";
                int opcionMenu2;
                ...
                { // User escogio ver videos por calificacion
                    cout << "Ingresa la calificacion de la cual deseas buscar videos (El programa solo tomara hasta el primer decimal que ingreses): ";
                ...
                { // User escogio ver videos por genero
                    ...
                    cout << "\nIngrese el genero del cual deseas buscar videos (El programa solo tomara el entero del numero que ingreses): ";
        ...
        else if (opcion == 3) // Mostrar los episodios de una determinada serie con una calificacion determinada
        {
            ...
            if (hayArchivos)
            {
                ...
                cout << "\nIngresa el numero de la serie que desees (El programa solo tomara el entero del numero que ingreses): ";
                int opcionSerie;
                ...
                cout << "Ahora selecciona la calificacion a buscar en dicha serie (El programa solo tomara hasta el primer decimal que ingreses): ";
        ...
        else if (opcion == 4) // Mostrar las peliculas con cierta calificacion
        {
            ...
            if (hayArchivos)
            {
                ...
                cout << "\nIntroduce la calificacion a buscar (El programa solo tomara hasta el primer decimal que ingreses): ";
        ...
        else if (opcion == 5) // Calificar un video
        {
            ...
            if (hayArchivos)
            {
                ...
                int opcionCalif;
                cout << "\nCalificar:\n1. Episodio de una Serie\n2. Pelicula\n\nIngresa el numero de la opcion deseada (El programa solo tomara el entero del numero que ingreses): ";
                ...
                if (opcionCalif == 1)
                {
                    ...
                    cout << "\nElige la opcion de tu gusto (El programa solo tomara el entero del numero que ingreses): ";
                    int serie;
                    ...
                    cout << "\nElige el episodio  a calificar (El programa solo tomara el entero del numero que ingreses): ";
                    int episodio;
                    ...
                    cout << "Introduce la nueva calificacion (El programa solo tomara hasta el primer decimal que ingreses): ";
                ...
                else if (opcionCalif == 2)
                {
                    ...
                    cout << "\nElige la pelicula a calificar (El programa solo tomara el entero del numero que ingreses): ";
                    int pelicula;
